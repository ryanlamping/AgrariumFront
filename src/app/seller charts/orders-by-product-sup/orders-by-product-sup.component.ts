...
@Component({
  selector: 'app-orders-by-product-sup',
  standalone: true,
  imports: [],
  templateUrl: './orders-by-product-sup.component.html',
  styleUrl: './orders-by-product-sup.component.scss'
})
export class OrdersByProductSupComponent {
  totalOrders: any[] = [];
  ...
  ngOnInit(): void {
    ...
    this.dashboardService.getOrdersByProductSup(user_id).subscribe(
      (data) => {
