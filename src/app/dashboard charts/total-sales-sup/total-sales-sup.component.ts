...
@Component({
  selector: 'app-total-sales-sup',
  standalone: true,
  imports: [],
  templateUrl: './total-sales-sup.component.html',
  styleUrl: './total-sales-sup.component.scss'
})
export class TotalSalesSupComponent implements OnInit{
  totalOrders: any[] = [];
  suppliers: string[] = [];
  totalSales: number[] = [];
  ...
  ngOnInit(): void {
    this.dashboardService.getSalesBySupplier().subscribe(
      (data) => {
  ...
  generateChart() {
    ...
    const ctx = document.getElementById('salesBySup') as HTMLCanvasElement;
